namespace SteganographyApp.Common.IO
{
    ...
    public class ChunkTableReader : AbstractChunkTableIO
    {
        ...
        private short ReadChunkCount(IRandomizeUtil randomizeUtil)
        {
            ...
            {
                headerBinary = randomizeUtil.ReorderBinaryString(headerBinary, Arguments.RandomSeed, 0, 100);
            }
        ...
        private ImmutableArray<int> ReadTableChunkLengths(IRandomizeUtil randomizeUtil, short chunkCount)
        {
            ...
            if (!string.IsNullOrEmpty(Arguments.RandomSeed))
            {
                tableBinary = randomizeUtil.ReorderBinaryString(tableBinary, Arguments.RandomSeed, 0, 100);
            }
