...
public class MatchResult(RegisteredArgument registeredArgument, string input)
{
    /// <summary>
    /// Gets the argument attribute.
    /// </summary>
    public ArgumentAttribute Attribute { get; } = registeredArgument.Attribute;

    /// <summary>
    /// Gets the reflective info about the field or property being set.
    /// </summary>
    public MemberInfo Member { get; } = registeredArgument.Member;
    ...
    /// </summary>
    public Func<object, string, object> Parser { get; } = registeredArgument.Parser;
}
